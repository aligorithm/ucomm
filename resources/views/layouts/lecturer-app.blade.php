...
<body>
<div id="app">
    <nav class="navbar navbar-default navbar-static-top" style="background:#33C5BA;">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (!Auth::guard('lecturer')->check())
                        <li><a href="{{ route('lecturer.login') }}" class="white">Login</a></li>
                        <li><a href="{{ route('lecturer.register') }}" class="white">Register</a></li>
                    @else
                        <li class="dropdown">
                                ...
                                <li>
                                    <a href="{{ route('lecturer.logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" class="white">
                                        Logout
                                    </a>
